...
export const Contacto = () => {
    return (
        <div className="bg-gray-200 w-full sm:p-10 p-5 flex gap-5  rounded-sm justify-center items-center overflow-hidden  ">
            <div className="flex flex-col sm:sw-1/2 sm:max-w-1/2  sm:px-10">
                ...
                <div className="rounded-sm w-full overflow-hidden  max-h-[500px] grid grid-flow-col grid-rows-3 gap-2">
                    <div className="row-span-3 rounded-sm overflow-hidden">
                        <video
                            ...
                            muted
                            loop
                            playsInline src="/videos/cantoF.mp4" alt="" className="w-full h-full object-cover" />
                    </div>
