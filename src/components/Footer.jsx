...
export const Footer = () => {
    return (
        <footer className="  bg-neutral-950 ">
            <section className="w-full  max-w-[1000px] m-auto flex justify-center sm:items-start  gap-8 sm:justify-between flex-col md:flex-row items-center py-20 list-none px-20">
                ...
                <div className="mb-3 w-full flex flex-col justify-center items-center">
                    ...
                    <div className="rounded-sm w-[400px] h-[350px] overflow-hidden flex justify-center items-center">
