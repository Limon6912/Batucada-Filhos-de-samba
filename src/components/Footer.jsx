...
export const Footer = () => {
    return (
        <footer className="  bg-neutral-950 ">
            <section className="w-full  max-w-[1200px] m-auto flex  gap-8 justify-center flex-col lg:flex-row items-center py-20 list-none  overflow-hidden ">
                <div className=" mb-3  text-center   border-neutral-50 flex  items-center justify-center  flex-col min-w-[300px] px-5">
                ...
                <div className="mb-3 w-full flex flex-col justify-center items-center  lg:border-l-[1px] lg:px-10 h-full ">
                    <h3 className="mb-3 text-3xl font-bold">Ubicación</h3>
                    <div className="lg:rounded-sm h-[350px] overflow-hidden flex justify-center items-center w-full">
