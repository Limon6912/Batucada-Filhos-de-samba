...
export const QuienSomos = () => {
    ...
    return (
        <section className='flex flex-col items-center justify-center mb-30  text-[var(--color-texto)] '>
            ...
            <div className='flex flex-col justify-center  mt-30 tracking-wide font-light text-center  flex-1 max-w-[1000px]'>
                <h2 className='text-6xl  text-[var(--color-verde)] pb-4  font-medium'><samp className='text-[var(--color-amarillo)]'>¿Quiénes somos </samp>y por qué estamos aquí? </h2>
